-- =====================================================
-- URBANNEST SUPABASE CLEAN SETUP (NO DUPLICATES)
-- =====================================================
...
-- =====================================================
-- 2. PROPERTIES TABLE (CLEAN - NO DUPLICATES)
-- =====================================================
CREATE TABLE properties (
    ...
    -- Owner Information (only owner_id, get other details from users table)
...
INSERT INTO users (email, name, roles, is_verified) 
VALUES ('admin@urbannest.com', 'Admin User', ARRAY['admin'], true);

-- Insert sample property owner
INSERT INTO users (email, name, roles, is_verified) 
VALUES ('owner@urbannest.com', 'Property Owner', ARRAY['owner'], true);
...
--
-- Next steps:
-- 1. Go to Storage and create buckets: 'properties', 'profiles', 'temp'
-- 2. Update your app code to use Supabase client
-- 3. Test the connection
-- 4. Migrate your Firebase data
